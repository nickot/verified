...
function addContact()
{
    ...
    if (window.location.hash) {
        ...
        query.get(hash, {
            success: function(contact) {
                contact_obj = contact;
                $("#company").val(contact.attributes.contact);
                $("#contact").val(contact.attributes.contact);
    ...
    $("#addContact").click(function() {
        ...
        if ($("#frm_addContact").validationEngine('validate'))
        {
            ...
            contact.set("contact", $('#contact').val());
...
//                    $("#message").html("<div class='success'>Contact has been  saved successfully. </div>");
//                    emptyForm('frm_addBuyer');
//                    hideLoader();
                },
                error: function(user, error) {
        ...
        success: function(contacts) {
            if (contacts.length > 0)
            {
                $.each(contacts, function(i, contact) {
                    ...
                    $('#contacts_listing').append('<li><a class="ui-btn ui-btn-icon-right ui-icon-carat-r" data-ajax="false" href="addcontact.html#' + contact.id + '">' + contact.attributes.company + ' ' + contact.attributes.contact + '</a></li>');
